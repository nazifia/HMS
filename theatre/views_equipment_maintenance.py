...
class EquipmentMaintenanceLogListView(LoginRequiredMixin, ListView):
...
class EquipmentMaintenanceLogCreateView(LoginRequiredMixin, CreateView):
...
class EquipmentMaintenanceLogUpdateView(LoginRequiredMixin, UpdateView):
