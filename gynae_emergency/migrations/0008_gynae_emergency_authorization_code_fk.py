...
gynae emergency stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("gynae_emergency", "Gynae_emergencyRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("gynae_emergency", "0007_gynae_emergencyrecord_hospital_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="gynae_emergency_records",
