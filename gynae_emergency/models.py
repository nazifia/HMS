...
class Gynae_emergencyRecord(TenantModel):
    ...
    requires_authorization = models.BooleanField(
        default=False,
        help_text="True if this NHIA patient gynae emergency record requires desk office authorization"
    )
    ...
    authorization_status = models.CharField(
        ...
        help_text="Status of authorization for this gynae emergency record"
    )
    authorization_code = models.ForeignKey('nhia.AuthorizationCode', on_delete=models.SET_NULL, null=True, blank=True, related_name='gynae_emergency_records')
...
class GynaeEmergencyClinicalNote(NigerianClerkingNote, TenantModel):
    """Nigerian clerking proforma clinical notes for gynae_emergency records"""
