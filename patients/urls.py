...
urlpatterns = [
    ...
    path('wallet/transactions/<int:transaction_id>/receipt/', views.wallet_transaction_receipt, name='wallet_transaction_receipt'),
    path('<int:patient_id>/vaccination/add/', views.add_vaccination, name='add_vaccination'),
    path('<int:patient_id>/wallet/sync-admission-charges/', views.sync_admission_charges, name='sync_admission_charges'),
