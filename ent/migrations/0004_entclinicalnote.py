...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ent', '0003_entrecord_chief_complaint_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='EntClinicalNote',
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ent_clinical_notes_created', to=settings.AUTH_USER_MODEL)),
                ('ent_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_notes', to='ent.entrecord')),
            ],
            options={
