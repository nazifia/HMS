...
class Doctor(models.Model):
    ...
    experience = models.CharField(
        max_length=10, choices=EXPERIENCE_CHOICES, db_index=True
    )
    ...
    def __str__(self):
        return (
            f"Dr. {self.user.first_name} {self.user.last_name} - {self.specialization}"
        )
...
class DoctorAvailability(models.Model):
    ...
    doctor = models.ForeignKey(
        Doctor, on_delete=models.CASCADE, related_name="availability"
    )
    ...
    max_appointments = models.PositiveIntegerField(
        default=20, help_text="Maximum number of appointments for this time slot"
    )
...
class DoctorLeave(models.Model):
    ...
    doctor = models.ForeignKey(
        Doctor, on_delete=models.CASCADE, related_name="leaves", db_index=True
    )
    ...
    approved_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="approved_doctor_leaves",
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class DoctorExperience(models.Model):
    ...
    doctor = models.ForeignKey(
        Doctor, on_delete=models.CASCADE, related_name="experiences"
    )
    hospital_name = models.CharField(max_length=200)
    position = models.CharField(max_length=100)
    start_date = models.DateTimeField()
    end_date = models.DateTimeField(
        null=True, blank=True, help_text="Leave blank if currently working here"
    )
    description = models.TextField(blank=True, null=True)
...
class DoctorReview(models.Model):
    ...
    doctor = models.ForeignKey(
        Doctor, on_delete=models.CASCADE, related_name="reviews", db_index=True
    )
