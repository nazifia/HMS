...
urlpatterns = [
    ...
    path(
        "search-patients/",
        views.search_billing_patients,
        name="search_billing_patients",
    ),
    path(
        "prescription/<int:prescription_id>/create/",
        views.create_invoice_for_prescription,
        name="create_invoice_for_prescription",
    ),
    path(
        "admission/<int:admission_id>/create/",
        views.create_invoice_for_admission,
        name="create_invoice_for_admission",
    ),
    path(
        "admission/<int:admission_id>/payment/",
    ...
    path(
        "services/<int:service_id>/delete/", views.delete_service, name="delete_service"
    ),
    path(
        "patient/<int:patient_id>/invoices/",
        views.patient_invoices,
    ...
    path(
        "reports/export/csv/", views.export_billing_report_csv, name="export_report_csv"
    ),
    path("admission-invoices/", views.admission_invoices, name="admission_invoices"),
    # Medication billing URLs
    path(
        "medications/",
        views.medication_billing_dashboard,
        name="medication_billing_dashboard",
    ),
    path(
        "medications/prescription/<int:prescription_id>/",
        views.prescription_billing_detail,
        name="prescription_billing_detail",
    ),
    path(
        "medications/prescription/<int:prescription_id>/payment/",
        views.process_medication_payment,
