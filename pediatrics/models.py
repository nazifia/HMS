...
class PediatricsRecord(TenantModel):
    ...
    requires_authorization = models.BooleanField(
        default=False,
        help_text="True if this NHIA patient paediatrics record requires desk office authorization"
    )
    ...
    authorization_status = models.CharField(
        ...
        help_text="Status of authorization for this paediatrics record"
    )
    authorization_code = models.ForeignKey('nhia.AuthorizationCode', on_delete=models.SET_NULL, null=True, blank=True, related_name='pediatrics_records')
...
class PediatricsClinicalNote(NigerianClerkingNote, TenantModel):
    """Nigerian clerking proforma clinical notes for pediatrics records"""
