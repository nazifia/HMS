...
paediatrics stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("pediatrics", "PediatricsRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("pediatrics", "0003_pediatricsclinicalnote_hospital_and_more"),
    ]

    operations = [
        migrations.RenameField(
            model_name="pediatricsrecord",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="pediatrics_records",
