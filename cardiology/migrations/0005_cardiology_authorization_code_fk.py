...
cardiology stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("cardiology", "CardiologyRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("cardiology", "0004_cardiologyclinicalnote_hospital_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="True if this NHIA patient cardiology record requires desk office authorization",
            ),
        ),
        migrations.AddField(
            model_name="cardiologyrecord",
            ...
            field=models.CharField(
                ...
                help_text="Status of authorization for this cardiology record",
                max_length=20,
            ),
        ),
        migrations.AddField(
