...
general medicine stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("general_medicine", "GeneralMedicineRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("general_medicine", "0003_generalmedicineclinicalnote_hospital_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="True if this NHIA patient general medicine record requires desk office authorization",
            ),
        ),
        migrations.AddField(
            model_name="generalmedicinerecord",
            ...
            field=models.CharField(
                ...
                help_text="Status of authorization for this general medicine record",
                max_length=20,
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="general_medicine_records",
