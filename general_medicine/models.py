...
class GeneralMedicineRecord(TenantModel):
    ...
    authorization_code = models.ForeignKey('nhia.AuthorizationCode', on_delete=models.SET_NULL, null=True, blank=True, related_name='general_medicine_records')
...
class GeneralMedicineClinicalNote(NigerianClerkingNote, TenantModel):
