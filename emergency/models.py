...
class EmergencyRecord(TenantModel):
    TRIAGE_LEVELS = (
    ...
    requires_authorization = models.BooleanField(
        default=False,
        help_text="True if this NHIA patient emergency record requires desk office authorization"
    )
    ...
    authorization_status = models.CharField(
        ...
        help_text="Status of authorization for this emergency record"
    )
    authorization_code = models.ForeignKey('nhia.AuthorizationCode', on_delete=models.SET_NULL, null=True, blank=True, related_name='emergency_records')
...
class EmergencyClinicalNote(NigerianClerkingNote, TenantModel):
    """Nigerian clerking proforma clinical notes for emergency records"""
