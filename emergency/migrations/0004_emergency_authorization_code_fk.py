...
emergency stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("emergency", "EmergencyRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("emergency", "0003_emergencyclinicalnote_hospital_and_more"),
    ]

    operations = [
        migrations.RenameField(
            model_name="emergencyrecord",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="emergency_records",
