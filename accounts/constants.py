...
ROLE_MEDICAL_LAB_SCIENTIST = "medical_lab_scientist"
...
ROLE_THEATRE_STAFF = "theatre_staff"
...
ROLE_CHOICES = (
    ...
    (ROLE_MEDICAL_LAB_SCIENTIST, "Medical Lab Scientist"),
    ...
    (ROLE_THEATRE_STAFF, "Theatre Staff"),
)
...
ROLE_HIERARCHY = {
    ...
    ROLE_LAB_TECHNICIAN: [ROLE_MEDICAL_LAB_SCIENTIST, ROLE_ADMIN],
    ROLE_MEDICAL_LAB_SCIENTIST: [ROLE_ADMIN],
    ROLE_RADIOLOGY_STAFF: [ROLE_ADMIN],
    ROLE_ACCOUNTANT: [ROLE_ADMIN],
    ROLE_HEALTH_RECORD_OFFICER: [ROLE_ADMIN, ROLE_RECEPTIONIST],
    ROLE_THEATRE_STAFF: [ROLE_ADMIN],
}
