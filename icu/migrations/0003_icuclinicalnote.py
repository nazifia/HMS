...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('icu', '0002_icurecord_authorization_code'),
    ]

    operations = [
        migrations.CreateModel(
            name='IcuClinicalNote',
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='icu_clinical_notes_created', to=settings.AUTH_USER_MODEL)),
                ('icu_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_notes', to='icu.icurecord')),
            ],
            options={
