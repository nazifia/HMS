...
class OphthalmicRecord(TenantModel):
...
class OphthalmicClinicalNote(NigerianClerkingNote, TenantModel):
    """Nigerian clerking proforma clinical notes for ophthalmic records"""
