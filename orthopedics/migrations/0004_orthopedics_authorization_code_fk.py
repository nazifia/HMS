...
orthopaedics stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("orthopedics", "OrthopedicsRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("orthopedics", "0003_orthopedicsclinicalnote_hospital_and_more"),
    ]

    operations = [
        migrations.RenameField(
            model_name="orthopedicsrecord",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="orthopedics_records",
