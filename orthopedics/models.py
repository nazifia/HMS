...
class OrthopedicsRecord(TenantModel):
    ...
    requires_authorization = models.BooleanField(
        default=False,
        help_text="True if this NHIA patient orthopaedics record requires desk office authorization"
    )
    ...
    authorization_status = models.CharField(
        ...
        help_text="Status of authorization for this orthopaedics record"
    )
    authorization_code = models.ForeignKey('nhia.AuthorizationCode', on_delete=models.SET_NULL, null=True, blank=True, related_name='orthopedics_records')
...
class OrthopedicsClinicalNote(NigerianClerkingNote, TenantModel):
    """Nigerian clerking proforma clinical notes for orthopedics records"""
