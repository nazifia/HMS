...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('anc', '0002_ancrecord_authorization_code'),
    ]

    operations = [
        migrations.CreateModel(
            name='AncClinicalNote',
            fields=[
                ...
                ('anc_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_notes', to='anc.ancrecord')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='anc_clinical_notes_created', to=settings.AUTH_USER_MODEL)),
            ],
            options={
