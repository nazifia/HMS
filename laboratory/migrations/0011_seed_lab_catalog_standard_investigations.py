...
def seed(apps, schema_editor):
    ...
    0009/0010 already ran on existing prod tenants, so catalog additions never
    reach them unless a fresh migration re-runs the seed. get_or_create keeps it
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("laboratory", "0010_seed_lab_catalog_expansion"),
        ("saas", "0001_initial"),
    ]
