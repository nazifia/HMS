...
class Family_planningRecord(models.Model):
    ...
    authorization_code = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Authorization code from desk office",
    )
...
class FamilyPlanningClinicalNote(models.Model):
    ...
    subjective = models.TextField(
        help_text="Patient's description of symptoms, concerns, and history"
    )
    objective = models.TextField(
        help_text="Observable findings, examination results, and measurements"
    )
    assessment = models.TextField(
        help_text="Clinical assessment, diagnosis, and interpretation"
    )
