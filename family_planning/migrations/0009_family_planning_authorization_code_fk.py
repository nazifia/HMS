...
family planning stored the desk office's code as a CharField, so nothing checked it
...
def link_existing_codes(apps, schema_editor):
    Record = apps.get_model("family_planning", "Family_planningRecord")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("family_planning", "0008_family_planningrecord_hospital_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="family_planning_records",
