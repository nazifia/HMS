    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='labor_clinical_notes_created', to=settings.AUTH_USER_MODEL)),
                ('labor_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_notes', to='labor.laborrecord')),
            ],
            options={
