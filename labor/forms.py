...
class LaborRecordForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'rupture_time': forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'form-control'}),
            'placenta_delivery_time': forms.DateTimeInput(attrs={'type': 'datetime-local', 'class': 'form-control'}),
